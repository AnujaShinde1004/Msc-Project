<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.Master" AutoEventWireup="true" CodeBehind="nonveg.aspx.cs" Inherits="ICCS_Canteen.nonveg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <fieldset class="auto-style10">
            <legend style="font-size: 25px; text-align:center" >Non-Veg</legend>
            <br />
...
&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/cart.aspx?id">Show cart</asp:HyperLink>
            <br />
            <br />
            <asp:DataList ID="dtlist" runat="server" DataKeyField="FoodName"  Height="468px" RepeatColumns="3" RepeatDirection="Horizontal" Width="1029px" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnItemCommand="dtlist_ItemCommand">
                ...
                <ItemTemplate>
                    <table border="0" class="auto-style11">
                        ...
                        <tr>
                            <td class="auto-style13">Price:<asp:Label ID="Label9" runat="server" Text='<%# Eval("Price") %>' Font-Size="Larger" Font-Underline="True"></asp:Label>
                            </td>
                        </tr>
                        <tr>
