<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.Master" AutoEventWireup="true" CodeBehind="icecream.aspx.cs" Inherits="ICCS_Canteen.icecream" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <fieldset class="auto-style10">
            <legend style="font-size: 25px; text-align:center" >Ice-Cream</legend>
            <br />
